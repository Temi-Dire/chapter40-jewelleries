  ...
  return (
    <div>
      <div className="h-screen sm:flex sm:justify-center sm:items-center md:grid md:grid-cols-2 md:items-center md:justify-items-center">
        ...
        <div className="md:w-7/10 p-8 md:p-0">
          ...
          <form action="" onSubmit={register}>
            ...
            <div
            className="w-full h-16 rounded-lg bg-[##FAFAFA] outline-none py-5 px-4 border border-[#E3E0E0] mb-10 flex"
            >
              <input
